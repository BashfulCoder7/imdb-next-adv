        ...
        <div>
          ...
          <div className="text-md text-gray-500 flex flex-col gap-6">
            ...
            <p>
              ...
              database up-to-date with the latest releases and trending
              content.
            </p>
            <p>
            ...
            <p>
              ...
              watch. Your feedback helps other users discover great content
              and enhances the overall community experience. Join us in
